export function generateSEOMetadata({
  ...
  const baseUrl = 'https://nikodecor.com';
...
export function generateProductSEO(product) {
  return generateSEOMetadata({
    ...
    canonicalUrl: `https://nikodecor.com/products/${product.slug || product._id}`,
...
export function generateBlogSEO(blog) {
  return generateSEOMetadata({
    ...
    canonicalUrl: `https://nikodecor.com/blog/${blog.slug || blog._id}`,
...
export function generateCategorySEO(category) {
  return generateSEOMetadata({
    ...
    canonicalUrl: `https://nikodecor.com/category/${category.slug || category._id}`,
