  ...
  useEffect(() => {
    const fetchBlogData = async () => {
      ...
      try {
        ...
        toast({
          title: "خطا",
          description: "خطا در بارگذاری اطلاعات بلاگ",
          variant: "destructive",
        });
      } finally {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response.status === 200) {
        toast({
          title: "موفقیت",
          description: "بلاگ با موفقیت بروزرسانی شد",
        });
        router.push("/adminnovin/blog");
      } else {
      ...
      toast({
        title: "خطا",
        description: "خطا در بروزرسانی بلاگ",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">اطلاعات مقاله را ویرایش کنید</p>
        </div>
