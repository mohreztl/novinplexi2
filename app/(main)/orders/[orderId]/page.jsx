...
export default function OrderDetails({ params }) {
  ...
  return (
    ...
    <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
      {/* هدر با گرادیانت */}
      <div className="bg-gradient-to-r from-primary-700 to-secondary-500 px-8 py-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">خلاصه سفارش</h1>
            <p className="text-secondary-200 mt-1">سفارش شما با موفقیت ثبت شد</p>
          </div>
          <Link
            href="/orders"
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-primary-50 p-4 rounded-xl">
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-primary-800 border-b-2 border-primary-100 pb-2">
          ...
          <div className="grid gap-4">
            {order.cartProducts.map((item) => (
              <div
                ...
                className="group flex items-center justify-between p-4 hover:bg-primary-50 rounded-xl transition-colors"
              >
                <Link
        ...
        <div className="bg-primary-50 p-6 rounded-xl">
          ...
          <div className="border-t border-primary-200 mt-4 pt-4">
            <div className="flex justify-between items-center">
              <p className="text-xl font-bold text-primary-800">مبلغ  پرداختی</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-primary-800">{order.name}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-primary-800">{order.country}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CreditCardIcon className="w-6 h-6 text-primary-600 mt-1" />
              <div>
                <p className="text-sm text-gray-500">کد پستی</p>
                <p className="font-medium text-primary-800">{order.postalCode}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* پشتیبانی */}
        <div className="text-center border-t border-primary-100 pt-6">
          <p className="text-gray-600">
            برای هرگونه سوال درباره سفارش با پشتیبانی تماس بگیرید:
          </p>
          <div className="mt-2">
            <a href="tel:02112345678" className="text-primary-600 hover:text-primary-700 font-medium">
   09128586016
            </a>
          </div>
        </div>
