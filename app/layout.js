...
"ورق‌های آکریلیک برای ساخت"],
  ...
  openGraph: {
    ...
    siteName: "نوین پلکسی",
    title: "فروش آنلاین ورق‌های آکریلیک پلکسی گلاس با کیفیت و قیمت مناسب | نوین پلکسی",
