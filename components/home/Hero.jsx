        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              نیکو دکور، برترین تولیدکننده محصولات اکریلیک
            </h1>
            <p className="text-gray-600 text-lg mb-8">
              طراحی و تولید انواع محصولات اکریلیک با بهترین کیفیت و قیمت مناسب. از تابلوهای تبلیغاتی گرفته تا دکوراسیون داخلی، همه را با ضمانت کیفیت در نیکو دکور بیابید.
            </p>
