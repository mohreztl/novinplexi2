      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <FiMapPin className="w-5 h-5 text-blue-400 mt-1 flex-shrink-" />
                <span className="mr-3 text-gray-400">تهران،تهران پلاک 1 واحد 1</span>
              </li>
              <li className="flex items-center">
                <FiPhone className="w-5 h-5 text-blue-400 flex-shrink-" />
                <span className="mr-3 text-gray-400">۰۲۱-۱۲۳۴۵۶۷۸</span>
              </li>
              <li className="flex items-center">
                <FiMail className="w-5 h-5 text-blue-400 flex-shrink-" />
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-">
