      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <GuaranteeItem
            ...
            title="پرداخت امن"
            description="پرداخت امن با درگاه پرداخت شاپرکی"
          />
          <GuaranteeItem
            icon={<RefreshCcw className="w-8 h-8" />}
            title="ضمانت سلامت کالا"
            description="تضمیین اصالت و سلامت کالا"
          />
          <GuaranteeItem
            icon={<Truck className="w-8 h-8" />}
            title="ارسال سریع"
            description="قابلیت ارسال سریع در شهر تهران و ارسال با پست به شهرستانا"
          />
          <GuaranteeItem
            icon={<Award className="w-8 h-8" />}
            title="بهترین قیمت"
            description="تمامی محصولات با کمترین قیمت ممکن عرضه خواهد شد"
          />
        </div>
      </div>
