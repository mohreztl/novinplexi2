...
const ProdDetailsPrice = ({
  ...
  return (
    <div className="md:w-1/2 px-4 sm:px-8 pb-8 sm:pt-20">
      <div className="relative overflow-hidden bg-primary rounded-2xl shadow-lg p-4 sm:p-8 mb-8 hover:shadow-2xl">
      ...
      <div className="flex-1 flex  ">
        <button
          ...
          className="flex-1 bg-gradient-to-r from-primary/85 to-primary/95 text-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center"
        >
          <ShoppingCart className="mr-2 h-6 w-6 ml-1 animate-bounce text-white" />
