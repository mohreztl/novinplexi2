...
import Watch from "@/public/contact-office.jpg";
      ...
      <div className="max-w-[45rem] py-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <button
              type="submit"
              className="w-full bg-blues text-white py-3 px-4 rounded-md shadow-xl hover:bg-blue-700 transition duration-300"
            >
              Subscribe Now
            </button>
          </motion.div>
